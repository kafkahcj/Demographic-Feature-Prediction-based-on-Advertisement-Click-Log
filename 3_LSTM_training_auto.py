...
########################### set the model name #########################
model_name = 'bilstm_win{}_size{}{}'.format(window,size,args.model_name)  #change here every experiment
...
for idx, (train_dataloader, val_dataloader, test_dataloader) in enumerate(data_folds):
    ...
    #set model
    model = BiLSTM(embedding_list, embedding_freeze, lstm_size=lstm_size, fc1=fc1, fc2=fc2,  num_layers=num_layers, rnn_dropout=rnn_dropout, fc_dropout=fc_dropout, embedding_dropout=embedding_dropout)    
